...
public class DeleteBook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(DeleteBook.this);
    ...
    private void searchGroup(String s) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                deleteBookListAdapter = new DeleteBookListAdapter(DeleteBook.this, bookModelArrayList);
                rv.setAdapter(deleteBookListAdapter);
                deleteBookListAdapter.notifyDataSetChanged();
            }
